...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://nextgenstreamer.com/guides/shure-sm7b-review-worth-it'
  }
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link href="/gear-hardware/best-microphones-2025" className="block p-6 bg-blue-50 rounded-lg border border-blue-200 hover:shadow-lg transition-shadow">
            ...
            <Link href="/gear-hardware/xlr-vs-usb-microphones-2025" className="block p-6 bg-green-50 rounded-lg border border-green-200 hover:shadow-lg transition-shadow">
