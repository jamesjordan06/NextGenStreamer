...
const metadata: Metadata = {
  title: 'All Creator Gear & Equipment',
  description: 'Browse our complete collection of microphones, webcams, and lighting equipment for content creators.',
}
...
export default function ProductsPage() {
  ...
  const categories = ['all', 'microphones', 'webcams', 'lighting']
